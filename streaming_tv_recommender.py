...
traits = ["Satirical", "Meta", "Dark", "Witty", "Dry", "Wacky", "Irreverent", "Dramatic", "Mind-Bending", "Cynical", "Heartfelt", "Violent", "Gritty", "Steamy", "Complex", "Easy-to-Watch", "Uncomfortable", "Provocative", "Epic", "Competitive", "Feel-Good", "Nostalgic", "Emotional", "Psychological", "Mysterious", "Political", "Dystopian", "Non-English", "Animated", "For Kids"]
...
add_show("Euphoria", "HBO Max", ["Drama"], ["Provocative", "Dramatic"], "Serialized", "MA", 19, 8.4, 70, "A look at life for a group of high school students as they grapple with issues of drugs, sex, and violence.")
